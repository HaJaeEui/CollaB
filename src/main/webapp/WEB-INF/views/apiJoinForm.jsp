			...
			<div class="test">
				...
				<div class="body__row">
					<div class="find__top">
						...
						<div class="find__body__header__contents1">환영합니다 👋</div>
						<div class="find__body__header__contents2">콜라비 회원이 되어서 편하게
							협업하세요!</div>
					</div>
					...
					<div class="contents__body">
						...
						<ul class="body__top">
							<li><span>개인정보 수집 및 이용 동의</span> <span class="essential">(필수)</span><span><input
									type="checkbox" id="chk"></span></li>
							<li><span>이용약관 동의 </span> <span class="essential">(필수)</span><span><input
									type="checkbox" id="chk2"></span></li>
							<li><span class="underline"></span></li>
						</ul>

						<div class="form__input">
							<form id="joinForm" name="joinForm" method="post"
								onsubmit="formCheck()" action="apiUserInsert.do">
								<div class="formBox">
									<div>
										 <div>
								...
								<div class="formBox">
									<div>
										<span class="label">*비밀번호</span>&nbsp;<span class="msgGrp"
											id="pwMsg" style="font-size: 11px;">영문 대소문자, 숫자, 특수기호
											조합하여 10~20자 🔒</span>
									</div>
								...
								<div class="formBox">
									<div>
										<span class="label">비밀번호 확인</span>&nbsp;<span class="msgGrp"
											id="pwChkMsg" style="font-size: 11px;"></span>
									</div>
...
<div class="modal" id="modal2">
	<div class="contentOfModal">
		...
		<div class="hiddenInput">
			<input type="hidden" id="apiEmail" data-value="email"
				value="${email }"> <input type="hidden" id="apiNickname"
				data-value="nickname" value="${nickname }"> <input
				type="hidden" id="apiName" data-value="name" value="${name }">
	...
	$(function(){
		...
		for(let hiddenInput of hiddenInputs){
			...
			if($(hiddenInput).val() != ''){
				...
				$("#"+inputName).val(inputVal).attr("readonly" , "readonly");
			}
		}
